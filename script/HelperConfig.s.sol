...
contract HelperConfig is CodeConstants, Script {
    ...
    function createSepoliaEthConfig() private {
        NetworkConfig memory sepoliaConfig = NetworkConfig({
            ...
            vrfCoorfinator: 0x9DdfaCa8183c41ad55329BdeeD9F6A8d53168B1B,
    ...
    function createMainnetEthConfig() private {
        NetworkConfig memory mainnetConfig = NetworkConfig({
            entranceFee: 0.1 ether,
            interval: 30, // 30 seconds
            vrfCoorfinator: 0xD7f86b4b8Cae7D942340FF628F82735b7a20893a,
    ...
    function createAnvilEthConfig() private {
        ...
        NetworkConfig memory anvilConfig = NetworkConfig({
            entranceFee: 0.1 ether,
            interval: 30, // 30 seconds
            vrfCoorfinator: address(vrfCoordinatorMock),
